...
<body class="min-h-screen flex items-center justify-center">
  ...
  <div class="bg-white p-10 rounded-3xl shadow-2xl w-full max-w-md border-4 border-green-300">
    ...
    <div class="flex flex-col items-center mb-6">
      <div class="bg-gradient-to-br from-green-400 to-green-600 rounded-full p-5 shadow-md animate-pulse">
        <i class="fa-solid fa-hat-wizard text-white text-4xl"></i>
      </div>
      <h2 class="font-title text-3xl text-green-700 mt-3 drop-shadow-lg">Add New Student 💚</h2>
      <p class="text-sm text-green-600 mt-1">Let's welcome a magical new student ✨</p>
    </div>
