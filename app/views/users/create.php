...
<head>
  ...
  <style>
    ...
    table thead tr { background: linear-gradient(90deg, #4bf34cff, #28f358ff, #0cf10cff); }
    .hp-page { 
      padding: 6px 12px; 
      background: #28a745; 
...
<body class="min-h-screen">
  ...
  <!-- Header -->
  <nav class="bg-gradient-to-r from-green-400 via-green-500 to-green-600 shadow-lg border-b-4 border-green-300">
  ...
  <div class="max-w-6xl mx-auto mt-10 px-4">
    <div class="bg-white shadow-2xl rounded-3xl p-6 border-4 border-green-300">
      ...
      <div class="flex justify-between items-center mb-6 flex-wrap gap-4">
        ...
        <form method="get" action="<?=site_url()?>" class="flex">
          <input 
            ...
            class="px-4 py-2 border-2 border-green-300 rounded-l-2xl focus:outline-none focus:ring-2 focus:ring-green-400 w-64 bg-green-50 placeholder-gray-400">
          <button type="submit" class="bg-green-400 hover:bg-green-500 text-white px-4 py-2 rounded-r-2xl shadow transition-all duration-300">
        ...
        <a href="<?=site_url('users/create')?>"
           class="btn-hover inline-flex items-center gap-2 bg-gradient-to-r from-green-400 to-green-600 text-white font-bold px-5 py-2 rounded-2xl shadow-md transition-all duration-300">
          <i class="fa-solid fa-user-plus"></i> Add Student
        </a>
      </div>

      <!-- Table -->
      <div class="overflow-x-auto rounded-3xl border-4 border-green-300 shadow-md">
